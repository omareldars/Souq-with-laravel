...
class AdminsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $role = ($request->has('role') && auth()->user()->hasRole('manager')) ? $request->role : 'receptionist';
    ...
    public function update(Request $request, Admin $admin)
    {
        ...
        $role = ($request->has('role') && auth()->user()->hasRole('admin')) ? $request->role : $admin->roles->first()->name;
